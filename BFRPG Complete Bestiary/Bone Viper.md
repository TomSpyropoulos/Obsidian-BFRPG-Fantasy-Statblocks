...
traits:
  ...
  - name: Damage Resistance
    desc: "Like humanoid skeletons they only take half damage from edged weapons and one single point of damage (plus any magical bonus) from small missile weapons like arrows or sling stones."
actions:
  - name: bite or 1 spit
    desc: "D20 to hit, 1d4 (`dice:1d4`) + poison bite or special"
source: BFRPG Field Guide
```
