...
modifier: 0
stats: ["1", "4", "14", "near"]
attack: "+1 (`dice: 1d20+1`) 1 weapon or special"
...
About one-quarter (25%) of thulids are Wizards (roll 1d8 for level). The experience point value of a magic-using thulid is greater than normal, and is shown in parentheses after the standard amount.

When encountered away from their lair, a group of thulids will generally consist of at least one fully mature (8 LVL) thulid, with the remainder having 2d4 LVL each. See below for details on thulid growth and maturation.

Thulids are actually a strange sort of parasite. When a group of thulids are encountered, the GM should roll 1d20. If the result of this roll is equal to or less than the number encountered, one of the thulids is ready to spawn. Do not count thulids who have only a single LVL, as these are not mature enough to reproduce.
...
A "newborn" thulid normally has 1 LVL. Over the course of the next year the new thulid will slowly transform, taking on a reddish skin tone and developing the distinctive thulid head; at this point the thulid gains its second LVL. Each year thereafter, the thulid gains another LVL, until the maximum of 8 is reached. Only a few thulids have the capacity to advance beyond 8 LVL.
