...
traits:
  ...
  - name: Escape
    desc: "A victim may attempt to escape by rolling a DC 13 CON check with Strength bonus added; this is a full action, so the victim may not attempt this and also perform an attack."
  - name: Sense
    desc: "They have no visual organs but can sense foes within 30 feet by sound and vibration."
actions:
  - name: entangle + special
    desc: "D20 to hit, 1d8 (`dice:1d8`) entangle + special"
source: BFRPG Core
```
