...
traits:
  ...
  - name: Undead Immunities
    desc: "As undead, it is immune to sleep, charm, and hold, and can be Turned by a Cleric (as a mummy)."
actions:
  - name: touch or bell
    desc: "D20 to hit, Attract all undead touch, deaf 1d4 (`dice:1d4`) rounds bell"
source: BFRPG Field Guide
```
