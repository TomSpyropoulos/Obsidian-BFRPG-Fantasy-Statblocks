...
modifier: 1
stats: ["4", "18", "13", "near"]
attack: "+4 (`dice: 1d20+4`) 2 claws (1d4) / 1 bite (1d8)"
damage: "-"
...
A skragg attacks with its claws and teeth. Like a regular troll, it has the ability to regenerate; however, a skragg must have at least 50% of its body immersed in water for its regeneration to take effect. Unlike a typical troll, a skragg regenerates from acid damage, but it fears fire like other trolls; the lower WIS modifier (in parenthesis) is used when the skragg faces attackers armed with fire.
