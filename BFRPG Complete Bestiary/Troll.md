...
traits:
  - name: "Regeneration"
    desc: "Trolls have the power of regeneration; they heal 1 hit point of damage each round after being injured. A troll reduced to 0 hit points is not dead, but only disabled for 2d6 rounds, at which point it will regain 1 hit point. Note that the troll may 'play dead' until it has regenerated further. Damage from fire and acid cannot be regenerated, and must heal at the normal rate; a troll can only be killed by this sort of damage. The lower WIS modifier (in parentheses) is used when the troll faces attackers armed with fire or acid."
