...
Most gnomes encountered outside their home are warriors; the statistics above are for such. In the lair, for every warrior there will be an average of three civilians having 1-1 Levels and Armor Class 11; such gnomes have morale (CHA) of 7. One out of every eight gnome warriors will be a sergeant having 3 Levels (145 XP). Gnomes gain a +1 bonus to their morale (CHA) if they are led by a sergeant. Both warriors and sergeants commonly wear chainmail. In gnomish communities, one out of every sixteen warriors will be a captain of 5 Levels (360 XP) with an Armor Class of 16 (11), adding a shield. In addition, in communities of 35 or greater, there will be a king of 7 Levels (670 XP), with an Armor Class of 18 (11), in plate mail and carrying a shield, having a +1 bonus damage due to strength. In their community, gnomes never fail a DC 12 CHA check as long as the king is alive. There is a chance equal to 1-4 on 1d6 that a community will have a Cleric of level 1d6+1, and 1-2 on 1d6 of a Wizard of level 1d6. Gnomish Clerics and Wizards are equivalent to regular gnomish warriors statistically.
