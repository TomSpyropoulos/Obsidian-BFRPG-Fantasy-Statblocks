...
traits:
  - name: Lightning Bolts
    desc: "Work just as the spell does, and can be used once per five rounds; a save vs. Spells reduces damage to half."
  - name: Magic-User Abilities
    desc: "10% of storm giants have the abilities of a Magic-User of level 2 to 12 (2d6)."
actions:
  - name: giant weapon or 1 lightning bolt
    desc: "D20 to hit, 8d6 or 15d6"
source: BFRPG Core
```
