...
modifier: 0
stats: ["1", "4", "14", "near"]
attack: "+1 (`dice: 1d20+1`) 2 claws or 2 weapons or 1 claw and 1 weapon (initiative +4)"
...
On the other hand, a hiveling can activate any magic item usable by a Wizard (including, of course, those usable by any class); even one that requires command words can be used, without need to actually speak the words. A hiveling is entirely capable of using a wand of fireballs, for example.
