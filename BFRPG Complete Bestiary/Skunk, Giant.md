...
actions:
  - name: "bite + special"
    desc: "D20 to hit, 1d6 (`dice:1d6`) bite + special"
source: BFRPG Field Guide
```

Giant Skunks live in the forest, but are not afraid to raid human communities for food when convenient. Due to their great size and much-feared special attack, humans often choose to avoid them; as a result, giant skunks generally do not fear humans.
