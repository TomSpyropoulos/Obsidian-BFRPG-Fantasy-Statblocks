...
traits:
  - name: Save Drain
    desc: "Once latched on, applies a save-targeting penalty against the victim's saves vs. Wands. Any single mite can only apply the penalty once, and the penalty persists until it is removed."
