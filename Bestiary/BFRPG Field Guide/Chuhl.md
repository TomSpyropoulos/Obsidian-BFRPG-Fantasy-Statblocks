...
If a victim is successfully attacked by a claw, they must succeed on a DC 14 CON check or be grappled. On subsequent turns the chuhl may constrict a grappled victim. Alternatively, the chuhl may instead pass a grappled victim to its hideous tentacled maw, causing the victim to make a DC 14 STR check or be paralyzed for 6 rounds. Once paralyzed (or constricted to death), the chuhl will drop the victim and then move on to the next target.
