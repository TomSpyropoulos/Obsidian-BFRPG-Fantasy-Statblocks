...
traits:
  - name: Fear Aura
    desc: "Upon sighting a headless horseman, characters of less than 5th level must save vs. Spells or be stricken with fear, running away until out of sight."
  - name: Fighter Abilities
    desc: "Each headless horseman is a Fighter with a level equivalent to its HD, and attacks appropriately."
