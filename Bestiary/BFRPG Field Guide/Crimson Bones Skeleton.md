...
traits:
  ...
  - name: Undead
    desc: "Can be Turned by a Cleric (as a zombie). Immune to **sleep**, **charm**, and **hold** spells. Immune to **mind reading**. Never fails morale (CHA) and always fights until destroyed."
actions:
  - name: punch or weapon
    desc: "D20 to hit, 1d6 punch, by weapon"
source: BFRPG Field Guide
```
