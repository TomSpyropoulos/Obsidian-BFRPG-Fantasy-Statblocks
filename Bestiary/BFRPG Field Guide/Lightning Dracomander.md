...
A lightning dracomander may project its breath weapon from either mouth, or even from both, but cannot use the breath weapon more times than it has levels in any day (an adult lightning dracomander cannot use its breath weapon 9 times per day from each mouth, but rather 9 times per day total). Anyone in the area of effect of both breath weapons in the same round suffers damage only from one of them (generally the one with the higher damage total).
