...
traits:
  - name: Hive-Mind
    desc: "All hivelings in a group are connected magically. Morale equals 2 plus the number of surviving hivelings in the group (maximum 12)."
  ...
  - name: Use Magic Items
    desc: "Can activate any magic item usable by a Magic-user (including those usable by any class). Can use items requiring command words without speaking them."
...
actions:
  - name: claws or 2 weapons or 1 claw and 1 weapon (initiative +4)
    desc: "D20 to hit, 1d4 claws, 1d6 or by weapon"
  - name: claws or 2 weapons or 1 claw and 1 weapon (initiative +4)
    desc: "D20 to hit, "
source: BFRPG Field Guide
```
