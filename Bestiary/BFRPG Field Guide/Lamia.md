...
actions:
  - name: bite
    desc: "D20 to hit, 1d6+poison bite, 2d6 constrict, by weapon"
  - name: Constrict
    desc: "D20 to hit, "
  - name: weapon
    desc: "D20 to hit, "
...
A lamia possesses a poisonous bite that causes paralysis for 1d4 turns when a victim fails a DC 13 CON check. It uses this poison to subdue its prey before devouring them. A lamia can wield weapons, often favoring bows, spears, and pole-arms.
