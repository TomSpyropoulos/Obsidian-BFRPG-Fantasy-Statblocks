...
A Flying Man-Of-War is a horse-sized flying jellyfish with a distinctive crest like a sail. Its body is filled with hot air, allowing it to float about 20 feet off the ground, with its tentacles hanging below. Any creature touched by its tentacles takes only 1 damage, but must succeed on a DC 12 STR check or be stunned for 1d4 rounds due to its paralyzing venom. The flying man-of-war will then pull itself down to its prey (if it weighs more than 100 lbs) or lift its prey up to its body and begin digesting it, dealing 1d6 points of damage per round.
