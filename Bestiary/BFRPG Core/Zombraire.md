...
traits:
  ...
  - name: Silent Movement
    desc: "Moves silently."
  - name: Sanity Loss
    desc: "Slowly rots away and loses its sanity, represented by variable morale. An insane zombraire fights to the death in hopes of being slain, thus ending its tortured existence."
actions:
  - name: dagger or 1 spell
    desc: "D20 to hit, 1d4 or per spell"
source: BFRPG Core
```
