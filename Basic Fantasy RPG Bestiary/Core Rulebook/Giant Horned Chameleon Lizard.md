...
traits:
  ...
  - name: Sticky Tongue
    desc: "Long tongue springs out up to 20' forward. The sticky muscular ball on the end grabs prey and drags it to the chameleon's mouth, doing bite damage automatically on the following round (and all subsequent rounds, until the chameleon is killed or fails a morale check, or until the prey is dead)."
actions:
