...
traits:
  - name: Fire Breath
    desc: "May breathe fire a number of times per day equal to its hit dice. Cone 10' wide at far end, length varies by HD: 10' long (3-4 HD), 20' long (5-6 HD), 30' long (7 HD). Damage 1d6 per HD. Save vs. Dragon Breath for half damage."
  - name: Attack Choice
