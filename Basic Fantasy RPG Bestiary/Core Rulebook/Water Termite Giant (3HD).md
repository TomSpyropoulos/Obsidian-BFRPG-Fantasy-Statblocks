...
traits:
  - name: Stunning Spray
    desc: "Range 5'. On hit, stuns target for a full turn. Save vs. Poison negates. Stunned character can neither move nor take action for remainder of current round and all of next round."
  - name: Ship Damage
    desc: "Does 2d4 points of damage to ship's hull per round (no roll required) for 1d4 + hit dice rounds, then full. Eats noisily."
  - name: Habitat Variants
    desc: "Freshwater variety: 1-2 hit dice. Saltwater variety: 3-4 hit dice. Swamp variety: 2-3 hit dice."
actions:
  - name: spray
