...
traits:
  ...
  - name: Entangle
    desc: "A successful hit inflicts 1d8 points of damage, and the victim becomes entangled, suffering an additional 1d8 points of damage thereafter. The plant will continue to crush its victim until one or the other is dead or the victim manages to escape."
  - name: Escape
    desc: "A victim may attempt to escape by rolling a saving throw vs. Death Ray with Strength bonus added; this is a full action, so the victim may not attempt this and also perform an attack."
  - name: Sense
    desc: "They have no visual organs but can sense foes within 30 feet by sound and vibration."
actions:
  - name: entangle + special
    desc: "D20 to hit, 1d8 entangle + special"
source: Core Rulebook
```
