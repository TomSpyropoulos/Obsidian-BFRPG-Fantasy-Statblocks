...
traits:
  - name: Toxic Spray
    desc: "Sprays a cone of very hot and noxious gases 10' long and 10' wide at the far end. Causes 2d6 points of damage (save vs. Death Ray for half damage). Can be used up to five times per day, but no more often than once per three rounds."
