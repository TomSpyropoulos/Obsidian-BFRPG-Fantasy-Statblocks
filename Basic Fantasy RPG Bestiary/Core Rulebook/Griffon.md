...
traits:
  - name: Preference for Horses
    desc: "Will attack a horse over anything else. When mounted and horses come within 120', roll a morale check; if failed, the griffon will try to attack immediately."
