...
traits:
  ...
  - name: Disease
    desc: "5% chance of causing disease. Infected character sickens in 3d6 hours and loses one point of Constitution per hour. Save vs. Death Ray (adjusted by current Constitution bonus or penalty) after each point lost to break fever. Zero Constitution means death."
actions:
  - name: bite per pack
    desc: "D20 to hit, 1d6 + disease"
source: Core Rulebook
```
