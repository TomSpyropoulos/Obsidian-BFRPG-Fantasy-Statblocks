...
traits:
  - name: Spit Venom
    desc: "Can project venom up to 5'. Any creature hit must roll a save vs. Poison or be blinded permanently (though the cure blindness spell can be used to heal this injury)."
  - name: Poison Bite
    desc: "Those successfully hit must save vs. Poison or die."
actions:
  - name: bite or 1 spit
