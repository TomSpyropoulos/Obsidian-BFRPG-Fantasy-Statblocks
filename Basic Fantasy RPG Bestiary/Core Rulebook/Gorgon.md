...
traits:
  - name: Petrification Breath
    desc: "Breath covers an area 60' long by 10' wide. Can be used as many times per day as the monster has hit dice, but no more often than every other round. A save vs. Petrify is allowed to resist."
actions:
