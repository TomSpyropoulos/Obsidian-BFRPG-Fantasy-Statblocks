...
traits:
  ...
  - name: Barbed whip
    desc: "A minority of them will be armed with a barbed whip instead. The barbed whip only deals 1d4 points of damage, but will also stun an opponent for the same amount of rounds (unless a save vs. Magic Wands is made). A stunned opponent cannot attack but can still defend themselves (no loss to AC)."
  - name: Sharp tail
...
actions:
  - name: tail
    desc: "D20 to hit, 1d4 tail, by weapon, by spell"
