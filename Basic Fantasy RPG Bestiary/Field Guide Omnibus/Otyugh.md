...
traits:
  ...
  - name: Diseased Bite
    desc: "The recipient of the attack must save vs. Poison or contract filth fever (incubation period 1d3 days; 1d3 reduction of both Dexterity and Constitution)."
  - name: Communication
    desc: "Can communicate verbally using the predominate language of the area, usually Common."
actions:
  - name: tentacles
    desc: "D20 to hit, 1d6 tentacle, 1d8 bite + special"
  - name: tentacles
    desc: "D20 to hit, "
  - name: bite + special
    desc: "D20 to hit, "
