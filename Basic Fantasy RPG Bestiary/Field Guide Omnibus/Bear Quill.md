...
traits:
  ...
  - name: Moonlight Regeneration
    desc: "When under the light of a full moon, the quill-bear grows larger and gains a hit die; treat the extra hit points thus gained in a fashion similar to a potion of heroism. While exposed to moonlight, a common quill-bear will regenerate damage at a rate of 2 hit points per round. If the creature is killed but its body is left in moonlight, there is a 60% chance that the bear will arise again in 2d4 rounds with half of its hit points restored."
  - name: Nocturnal
