...
traits:
  ...
  - name: Heat Stroke
    desc: "If a wrong answer is given to her riddles, she will cause the one answering to suffer a heat stroke; the victim must save vs. Spells or take a -4 penalty to all attack rolls and ability checks for the next 2d6 hours."
actions:
  - name: scythe (1d8)
    desc: "D20 to hit, 1d8"
source: Field Guide Omnibus
