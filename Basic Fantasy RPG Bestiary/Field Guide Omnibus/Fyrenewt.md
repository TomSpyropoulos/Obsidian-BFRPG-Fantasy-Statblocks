...
traits:
  - name: Breath Weapon
    desc: "Cone-shaped spray of fluid that ignites upon contact with air. Usable once every ten rounds. 2d4 damage to creatures within 10 feet (half damage if save vs. Dragon Breath succeeds)."
  - name: Fire Immunity
...
actions:
  - name: weapon or 1 breath
    desc: "D20 to hit, By weapon or 2d4 breath"
source: Field Guide Omnibus
```
