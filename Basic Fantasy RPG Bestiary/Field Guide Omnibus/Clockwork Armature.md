...
traits:
  ...
  - name: Steam Vent
    desc: "Every five rounds, can vent steam from the nozzles surrounding the 'eye' in a 60-foot long cone, for 5d8 points of damage (half on a successful save vs. Breath Weapon)."
...
actions:
  - name: slash, 1 ray or steam
    desc: "D20 to hit, 1d10 slash, 2d8 ray, 5d8 steam"
  - name: slash, 1 ray or steam
    desc: "D20 to hit, "
source: Field Guide Omnibus
```
