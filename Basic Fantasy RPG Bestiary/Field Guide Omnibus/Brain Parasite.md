...
traits:
  ...
  - name: Burrowing
    desc: "After contact, there are 2 rounds to burn or cut it out before it reaches the brain. Either method kills the parasite and causes 2d6 points of damage to the host."
  - name: Brain Hibernation
    desc: "Burrows into the brain and hibernates there. After this point a **cure disease** spell will be the only way to save the victim."
  - name: Mind Control
    desc: "The victim will behave normally until encountering a carnivorous monster, at which point they will attempt to be slain by that monster (via an uncontrollable urge to be close to said monster and not defend oneself) so that the brain parasite can fertilize its eggs in the new monster's feces. Should the character fail to be slain by the first monster it sees, they will continue trying at the next opportunity until cured or killed."
actions:
  - name: bite
