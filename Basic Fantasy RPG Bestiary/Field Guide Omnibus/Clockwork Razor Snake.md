...
traits:
  ...
  - name: Constrict
    desc: "Can coil around their victims, requiring a successful attack roll, and the victim to then fail a save vs. Dragon Breath. Once their victim is looped in their coils they constrict for 3d10 damage as the razor-sharp blades cut into the trapped victim."
  - name: Always Attack
...
actions:
  - name: lash or constrict
    desc: "D20 to hit, 2d6 lash, 3d10 constrict"
source: Field Guide Omnibus
```
