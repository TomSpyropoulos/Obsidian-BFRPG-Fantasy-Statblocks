...
traits:
  - name: Telepathy
    desc: "A boggart has a passive form of telepathy so it knows the greatest fear of any opposing creature."
  - name: Fear Illusion
    desc: "The boggart projects an illusory image of the feared item over itself. Creatures of 1 HD or less that view such an image must save vs. Death Ray or die of fright. In all other respects the illusion of a boggart functions like the spell phantasmal force."
  - name: Sound Imitation
    desc: "It is capable of imitating a wide range of sounds, including speech."
  - name: Weakness to Laughter
    desc: "The boggart finds laughter unbearable and must check morale if it hears the sounds of genuine mirth."
  - name: Immunities
