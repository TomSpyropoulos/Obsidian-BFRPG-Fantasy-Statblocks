...
traits:
  - name: Death Strike
    desc: "Whenever the twilight hound is mortally wounded, the snake tail will bite the nearest creature viciously; the victim must save vs. Poison or die, after which the hound will dissolve into nothing as it returns to its native plane."
