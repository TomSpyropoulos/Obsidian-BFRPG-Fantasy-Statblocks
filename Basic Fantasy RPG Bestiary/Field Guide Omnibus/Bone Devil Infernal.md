...
traits:
  ...
  - name: Spell-Like Abilities (At-Will)
    desc: "Once per round (instead of attacking) a bone devil can cast fly on itself, phantasmal force, invisibility on itself, detect invisible, or cause fear (reverse of the remove fear spell) in a 5-foot radius area around the creature (save vs. Spells to resist)."
  - name: Ice Storm
