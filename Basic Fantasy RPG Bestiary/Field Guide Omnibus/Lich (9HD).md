...
hp: 49
thaco: 12 [+8]
stats: ["10** (+9) or more see below", "49", "0 [19]", "12 [+8]"]
...
traits:
  - name: Terror
    desc: "Simply encountering a lich for the first time is so terrifying that the subject must save vs. Spells or flee for 2d6 rounds."
  - name: Terrifying Gaze
    desc: "Effective up to 30 feet, the affected target must save vs. Spells or be paralyzed in fright for 2d4 rounds."
  - name: Touch Attack
  ...
  - name: Spells and Powers
    desc: "A lich is an undead former Magic-user or Cleric of at least 10th-level with all spells and powers intact. Despite having Magic-user or Clerical levels, the lich uses 1d8 for rolling HP like other monsters."
actions:
