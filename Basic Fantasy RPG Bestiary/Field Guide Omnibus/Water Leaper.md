...
traits:
  ...
  - name: Tail Sting
    desc: "If a bite attack hits, a tail attack will be immediately done. A victim of a successful tail attack must save vs. Paralysis or be paralyzed for 3d4 rounds; a bite attack against a paralyzed victim will automatically latch."
...
actions:
  - name: bite (2d6)
    desc: "D20 to hit, 2d6 bite, 1d3 sting + paralysis"
