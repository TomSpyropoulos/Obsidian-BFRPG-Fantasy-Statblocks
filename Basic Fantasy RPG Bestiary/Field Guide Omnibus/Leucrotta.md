...
actions:
  - name: bite or 2 kicks
    desc: "D20 to hit, 3d6 bite, 1d6 kick"
source: Field Guide Omnibus
```
...
The leucrotta's kick attacks may only be directed at opponents behind the creature, and it cannot effectively bite and kick in the same round.
