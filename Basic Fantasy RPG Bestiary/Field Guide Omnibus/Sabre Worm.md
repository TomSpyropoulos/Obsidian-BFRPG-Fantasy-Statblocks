...
traits:
  ...
  - name: Drag into Sand
    desc: "Ambushed creatures hit by its jaws must save vs. Petrify or be dragged 30 feet per round into the sand, risking suffocation and the worm's vice-like grip."
  - name: Echo-location
    desc: "In darkness, uses loud clicking for echo-location, detecting prey up to 60 feet away, with 30-foot Darkvision."
  - name: Acid Spray
    desc: "Can spray a 5-foot wide jet of acid up to 40 feet, three times per day, with a save vs. Breath Weapon for half damage."
  - name: Sand Movement
