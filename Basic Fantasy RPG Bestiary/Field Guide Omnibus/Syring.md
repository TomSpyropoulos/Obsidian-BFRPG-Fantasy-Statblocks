...
traits:
  ...
  - name: Poison Bite
    desc: "A bitten individual must save vs. Poison at -3 or die."
  - name: Poisonous Sublimation
    desc: "A wound will reveal the syring's soft and spongy inside that rapidly will sublimate into the air. Creatures near the wounded syring, other than syrings, must save vs. Poison or suffer a -2 to their rolls for 2d4 rounds."
actions:
  - name: claws
    desc: "D20 to hit, 1d10 claw, 1d6 bite + poison"
  - name: claws
    desc: "D20 to hit, "
  - name: bite
    desc: "D20 to hit, "
