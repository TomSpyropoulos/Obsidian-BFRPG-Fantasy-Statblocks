...
traits:
  ...
  - name: Valuable Materials
    desc: "The magical fabric is worth up to 1d6x100 gp to Magic-users and tailors. If destroyed by fire, acid, or other such attacks, the material may be too damaged to sell."
actions:
  - name: fists
    desc: "D20 to hit, 1d6 fist"
  - name: fists
    desc: "D20 to hit, "
source: Field Guide Omnibus
```
