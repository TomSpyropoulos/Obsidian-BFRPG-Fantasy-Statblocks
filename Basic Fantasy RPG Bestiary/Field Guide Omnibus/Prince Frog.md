...
traits:
  ...
  - name: Poisonous Skin
    desc: "Secretions cause any creature coming in contact to save vs. Poison or become comatose for 2d4 turns. During this period the victim will have strange and horrifying dreams. A comatose victim cannot be awakened by normal means until the duration has expired. Effect checked anytime prince frog successfully attacks. Secretions remain fully potent for 1d4 turns after being separated from creature. Weapons used to successfully attack may cause same effect if touched, though +2 bonus allowed on saving throw."
actions:
  - name: claws
    desc: "D20 to hit, 1d4 claw, 1d6 bite + paralysis"
  - name: claws
    desc: "D20 to hit, "
  - name: bite + special
    desc: "D20 to hit, "
...
Some believe that a prince frog is a form of a Nazgorean (see page 187) monster, but its bright colors have caused most sages to discount this theory.
