...
traits:
  ...
  - name: Bestow Curse
    desc: "Once per day can bestow curse (reverse of remove curse) as a 7th-level Magic-user (usually utilizing the '-4 to attack rolls and saves' version)."
  ...
  - name: Magic Resistance
    desc: "It saves against magic (including wands) with a +4 bonus."
actions:
  - name: claws
